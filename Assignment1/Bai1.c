//Em su dung tham so dong lenh thay a, argv[1] la ten file nguon, nhu la : "alice30.txt", argv[2] la ten file chua cac tu ma khi gap thi chuong trinh bo qua khong dem, nhu la : "stopw.txt"
//File output la : "output.txt"
#include<stdio.h>
#include<ctype.h>
#include<stdlib.h>
#include<string.h>
